<template>
  <div class="m-product-card px-24">
    <div class="py-6">
      <div class="flex max-w-lg bg-white shadow-lg rounded-lg overflow-hidden h-64">
        <div
        ...
        <div class="w-2/3 p-10">
          ...
          <p class="mt-2 text-gray-600 text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit In odit exercitationem fuga id
            nam quia
          </p>
